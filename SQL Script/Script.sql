...
FROM fact__paper__digital_payment_transaction fpt
JOIN (
    ...
    SELECT
        ...
        -- Jika fungsi STDDEV tidak didukung, gunakan nilai tetap untuk deviasi standar atau hapus bagian ini
        0 AS stddev_amount  -- Jika STDDEV tidak bisa digunakan, coba menggunakan nilai 0 atau tentukan batas manual.
    FROM fact__paper__digital_payment_transaction
